...
input_path = "D:/metadata/OriginalPhoto/1.Converted/VHS014/IMG_8986.jpg"  # Đường dẫn tuyệt đối đến file gốc
...
def blur_region(img, x1, y1, x2, y2, blur_strength=420):
...
while True:
    ...
    if w > 0 and h > 0:
        image = blur_region(image, x, y, x + w, y + h, blur_strength=420)
