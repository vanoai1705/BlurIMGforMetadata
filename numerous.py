...
original_image = Image.open("D:/metadata/OriginalPhoto/HUI/FullSizeRender15.jpg")
...
def blur_region(img, x1, y1, x2, y2, blur_strength=400):
...
for (x1, y1, x2, y2) in regions:
    image = blur_region(image, x1, y1, x2, y2, blur_strength=400)
...
blurred_image.save("D:/metadata/Blurred/1117/P004S030IMG017.jpg", exif=exif_data)
