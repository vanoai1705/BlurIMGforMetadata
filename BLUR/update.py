...
input_path = "D:\metadataS2\OriginalPhoto\Oai\SS2_022/IMG_6922.jpg"  # Đường dẫn tuyệt đối đến file gốc
...
scale_percent = 40  # Giảm kích thước xuống còn 50% cho dễ chọn vùng
new_width = int(original_width * scale_percent / 100)
new_height = int(original_height * scale_percent / 100)
resized_image = cv2.resize(image, (new_width, new_height))

# Hàm làm mờ vùng được chọn
def blur_region(img, x1, y1, x2, y2, blur_strength=600):
...
while True:
    ...
    if w > 0 and h > 0:
        image = blur_region(image, x, y, x + w, y + h, blur_strength=600)
